function [d, fE] = NonLinearSolver2(K, F, dfixed, free, fixed, parallel)
%NONLINEARSOLVER2 Solve for unknown vector by zero-ing rows and columns in 
%stiffness matrix that correspond to essential boundaries
% 	d = NONLINEARSOLVER2(K, F, dfixed, free, fixed) is the displacement 
...
% 	vector dfixed. 
% 
% 	[d, fE] = NONLINEARSOLVER2(K, F, dfixed, free, fixed) also returns the 
