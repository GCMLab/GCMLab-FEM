function [d, fE] = NonLinearSolver1(K, F, dfixed, free, fixed, parallel)
%NONLINEARSOLVER1 Solves for unknown vector using partition method
% 	d = NONLINEARSOLVER1(K, F, dfixed, free, fixed) is the displacement 
...
% 	vector dfixed. 
% 
% 	[d, fE] = NONLINEARSOLVER1(K, F, dfixed, free, fixed) also returns the 
