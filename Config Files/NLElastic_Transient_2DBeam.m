...
%       
%   Mesh = NLELASTIC_TRANSIENT_2DBEAM(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = NLELASTIC_TRANSIENT_2DBEAM() also returns a
...
% 
%   [Mesh, Material, BC] = NLELASTIC_TRANSIENT_2DBEAM() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = NLELASTIC_TRANSIENT_2DBEAM() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
