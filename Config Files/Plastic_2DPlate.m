function [Mesh, Material, BC, Control] = Plastic_2DPlate(config_dir, progress_on)
...
%% Boundary Conditions
    ...
    % -----------------------------------------------------------------
        ...
        BC.fix_disp_dof = [BC.fix_disp_dof1];
...
%% Computation controls
        ...
        % DOF to plot
        Control.plotAt = Mesh.nDOF-1; % dof in y at bottom right node
