...
%FineMesh Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = FineMesh() is a structure array with the
%   following fields: 
...
%       
%   Mesh = FineMesh(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = FineMesh() also returns a
...
% 
%   [Mesh, Material, BC] = FineMesh() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = FineMesh() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
