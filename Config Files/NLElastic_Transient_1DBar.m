function [Mesh, Material, BC, Control] = NLElastic_Transient_1DBar(config_dir, progress_on)
%NLELASTIC_TRANSIENT_1DBAR Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = NLELASTIC_TRANSIENT_1DBAR() is a structure array with the
%   following fields: 
...
%       
%   Mesh = NLELASTIC_TRANSIENT_1DBAR(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = NLELASTIC_TRANSIENT_1DBAR() also returns a
...
% 
%   [Mesh, Material, BC] = NLELASTIC_TRANSIENT_1DBAR() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = NLELASTIC_TRANSIENT_1DBAR() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
