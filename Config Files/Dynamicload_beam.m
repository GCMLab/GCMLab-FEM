...
%DYNAMICLOAD_BEAM Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = DYNAMICLOAD_BEAM() is a structure array with the
%   following fields: 
...
%       
%   Mesh = DYNAMICLOAD_BEAM(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = DYNAMICLOAD_BEAM() also returns a
...
% 
%   [Mesh, Material, BC] = DYNAMICLOAD_BEAM() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = DYNAMICLOAD_BEAM() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
