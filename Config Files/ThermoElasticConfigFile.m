function [Mesh, Material, BC, Control] = ThermoElasticConfigFile(config_dir, progress_on)
%THERMOELASTICCONFIGFILE Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = THERMOELASTICCONFIGFILE() is a structure array with the
%   following fields: 
...
%% Boundary Conditions
    ...
    % -----------------------------------------------------------------
        % column vector of prescribed temperature dof  
        BC.fix_temp_dof = [];

        % prescribed temperature for each dof [u1; u2; ...] [m]
        BC.fix_temp_value = [];  
