% ------------------------------------------------------------------------
% Runs unit test - T3 manufactured solution convergence as a part of RunTests
% ------------------------------------------------------------------------
% Calculates the convergence rates of a uniform T3 mesh using a
...
% under plane stress conditions
        ...
        testnum = testnum + 1;
        testname = 'T3 Convergence - Plane stress manufactured solution';
        ...
        % Step 2 - Check results
            ...
            fprintf('\nT3 L2-norm converges at a rate of %.2f',m_L2)
            fprintf('\nT3  e-norm converges at a rate of %.2f',m_e)
            
            convergence_tolerance = 0.1;
            % allow higher tolerance for T3 elements, will converge to
