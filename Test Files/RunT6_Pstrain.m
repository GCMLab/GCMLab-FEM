% ------------------------------------------------------------------------
% Runs unit Test 6 - Q4 Plane strain manufactured solution convergence as a part of RunTests
% ------------------------------------------------------------------------
% Test 6 calculates the convergence rates of a uniform Q4 mesh using a
...
% under plane strain conditions
        ...
        fprintf('\n\n Test 6: Manufactured Solution - Plane Strain\n')
