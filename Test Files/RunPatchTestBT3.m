% ------------------------------------------------------------------------
% Runs unit test - Patch Test B T3 as part of RunTests
% ------------------------------------------------------------------------
...
% should be exact.
        ...
        testnum = testnum + 1;
        testname = 'Patch Test B - T3 elements';
        ...
        meshfilename = 'Mesh Files\PatchTestT3.msh';
        quadorder = 0;
        ...
        fprintf('\nT3-patch test B: Displacement error is %.2f',disp_er)
        fprintf('\nT3-patch test B: Stress error is %.2f',stress_er)
        fprintf('\nT3-patch test B: Reaction forces error is %.2f',reaction_er)
