...
% should be exact.
        ...
        testnum = testnum + 1;
        testname = 'Patch Test C - T3 elements';
...
%       main  % Runs calculation
        ...
        fprintf('\nT3-patch test C: Displacement error is %.2f',disp_er)
        fprintf('\nT3-patch test C: Stress error is %.2f',stress_er)
        fprintf('\nT3-patch test C: Reaction forces error is %.2f',reaction_er)
