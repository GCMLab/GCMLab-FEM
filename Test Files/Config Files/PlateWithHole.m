...
%       
%   Mesh = PLATEWITHHOLE(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = PLATEWITHHOLE() also returns a
...
% 
%   [Mesh, Material, BC] = PLATEWITHHOLE() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = PLATEWITHHOLE() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
