...
%MANUFACTUREDSOLUTION_PLANESTRAIN Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = MANUFACTUREDSOLUTION_PLANESTRAIN() is a structure array with the
%   following fields: 
...
%       
%   Mesh = MANUFACTUREDSOLUTION_PLANESTRAIN(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = MANUFACTUREDSOLUTION_PLANESTRAIN() also returns a
...
% 
%   [Mesh, Material, BC] = MANUFACTUREDSOLUTION_PLANESTRAIN() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = MANUFACTUREDSOLUTION_PLANESTRAIN() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
