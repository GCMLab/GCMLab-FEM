...
%MANUFACTUREDSOLUTION_PLANESTRESS Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = MANUFACTUREDSOLUTION_PLANESTRESS() is a structure array with the
%   following fields: 
...
%       
%   Mesh = MANUFACTUREDSOLUTION_PLANESTRESS(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = MANUFACTUREDSOLUTION_PLANESTRESS() also returns a
...
% 
%   [Mesh, Material, BC] = MANUFACTUREDSOLUTION_PLANESTRESS() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = MANUFACTUREDSOLUTION_PLANESTRESS() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
