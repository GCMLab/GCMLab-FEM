...
%PATCHTESTB_Q8 Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = PATCHTESTB() is a structure array with the
%   following fields: 
...
%       
%   Mesh = PATCHTESTB(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = PATCHTESTB() also returns a
...
% 
%   [Mesh, Material, BC] = PATCHTESTB() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = PATCHTESTB() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
