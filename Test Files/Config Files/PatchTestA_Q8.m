...
%PATCHTESTA_Q8 Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = PATCHTESTA_Q8() is a structure array with the
%   following fields: 
...
%       
%   Mesh = PATCHTESTA_Q8(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = PATCHTESTA_Q8() also returns a
...
% 
%   [Mesh, Material, BC] = PATCHTESTA_Q8() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = PATCHTESTA_Q8() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
