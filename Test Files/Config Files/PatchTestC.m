...
%PATCHTESTC Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = PATCHTESTC() is a structure array with the
%   following fields: 
...
%       
%   Mesh = PATCHTESTC(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = PATCHTESTC() also returns a
...
% 
%   [Mesh, Material, BC] = PATCHTESTC() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = PATCHTESTC() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
