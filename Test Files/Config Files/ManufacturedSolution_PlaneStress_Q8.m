...
%MANUFACTUREDSOLUTION_PLANESTRESS_Q8 Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = MANUFACTUREDSOLUTION_PLANESTRESS_Q8() is a structure array with the
%   following fields: 
...
%       
%   Mesh = MANUFACTUREDSOLUTION_PLANESTRESS_Q8(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = MANUFACTUREDSOLUTION_PLANESTRESS_Q8() also returns a
...
% 
%   [Mesh, Material, BC] = MANUFACTUREDSOLUTION_PLANESTRESS_Q8() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = MANUFACTUREDSOLUTION_PLANESTRESS_Q8() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
