...
%CIRCULARINLCUSION Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = CIRCULARINLCUSION() is a structure array with the
%   following fields: 
...
%       
%   Mesh = CIRCULARINLCUSION(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = CIRCULARINLCUSION() also returns a
...
% 
%   [Mesh, Material, BC] = CIRCULARINLCUSION() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = CIRCULARINLCUSION() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
