...
%TRANSIENTTEST Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = TRANSIENTTEST() is a structure array with the
%   following fields: 
...
%       
%   Mesh = TRANSIENTTEST(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = TRANSIENTTEST() also returns a
...
% 
%   [Mesh, Material, BC] = TRANSIENTTEST() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = TRANSIENTTEST() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
