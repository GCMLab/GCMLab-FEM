...
%PATCHTESTA Mesh, material parameters, boundary conditions, 
%and control parameters
%   Mesh = PATCHTESTA() is a structure array with the
%   following fields: 
...
%       
%   Mesh = PATCHTESTA(config_dir) defines the mesh using GMSH file 
%   import located in the directory config_dir
%
%   [Mesh, Material] = PATCHTESTA() also returns a
...
% 
%   [Mesh, Material, BC] = PATCHTESTA() also returns a structure
...
% 
%   [Mesh, Material, BC, Control] = PATCHTESTA() also returns a 
%   structure array with the following fields: 
%       .qo:            Quadrature order
